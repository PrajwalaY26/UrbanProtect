...
app.use(express.static(path.join(__dirname, '..','UrbanProtect','Frontend', 'HTML')));
app.use(express.static(path.join(__dirname, '..', 'UrbanProtect','Frontend', 'CSS')));
app.use(express.static(path.join(__dirname, '..', 'UrbanProtect','Frontend', 'img')));
app.use(express.static(path.join(__dirname, '..', 'UrbanProtect','Frontend', 'js')));
...
const sendFile = (res, filename, message) => {
    const filePath = path.join(__dirname, '..', 'UrbanProtect' ,'Frontend', 'HTML', filename);
